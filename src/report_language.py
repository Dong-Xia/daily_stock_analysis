...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "money_status_title": "市场资金状态",
        "money_status_amount_label": "两市成交额",
        "money_status_breadth_label": "涨跌比",
        "money_status_limit_up_label": "涨停",
        "money_status_limit_down_label": "跌停",
        "money_status_north_flow_label": "北向资金",
        "money_status_sector_label": "领涨板块",
        "money_status_advice_abundant": "逻辑驱动行情，可积极操作",
        "money_status_advice_balanced": "结构性行情，精选个股为主",
        "money_status_advice_scarce": "资金偏紧，注意仓位控制",
        "money_status_advice_clustering": "资金抱团行情，跟随主力方向",
        "money_status_clustering_hint": "（资金抱团，妖股轮番上涨）",
        "ann_heading": "交易原则",
        "ann_trend_status_label": "趋势确认",
        "ann_cycle_label": "三周期结构",
        "ann_heat_label": "热度",
    },
    "en": {
        ...
        "money_status_title": "Market Money Status",
        "money_status_amount_label": "Total Turnover",
        "money_status_breadth_label": "Breadth Ratio",
        "money_status_limit_up_label": "Limit Up",
        "money_status_limit_down_label": "Limit Down",
        "money_status_north_flow_label": "North-bound Flow",
        "money_status_sector_label": "Leading Sectors",
        "money_status_advice_abundant": "Capital-driven market, active trading favorable",
        "money_status_advice_balanced": "Structural market, selective stock picking",
        "money_status_advice_scarce": "Tight capital, control position sizing",
        "money_status_advice_clustering": "Capital clustering, follow dominant direction",
        "money_status_clustering_hint": "(capital clustering, speculative stocks rotate)",
        "ann_heading": "Trading Principles",
        "ann_trend_status_label": "Trend Confirmation",
        "ann_cycle_label": "Cycle Structure",
        "ann_heat_label": "Heat",
    },
}
